...
class DefaultLinuxPrintkApi(
    val abi: IAbi,
    override val PTR_PRINTK: ULong
) : LinuxPrintkCapturableApi {
    override fun printkCapturable(fmt: String, vararg args: FunArg) = abi.argsCapturable(
        fmt.toArg(),
        *args,
    )
}