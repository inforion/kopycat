...
import ru.inforion.lab403.kopycat.experimental.linux.api.interfaces.LinuxSysChmodCapturableApi


class DefaultLinuxSysChmodApi(
    val abi: IAbi,
    override val PTR_SYS_CHMOD: ULong
) : LinuxSysChmodCapturableApi {
    override fun sysChmodCapturable(filename: String, chmod: Int) = abi.argsCapturable(
        filename.toArg(),
        FunArg.Number(chmod),
    )
}