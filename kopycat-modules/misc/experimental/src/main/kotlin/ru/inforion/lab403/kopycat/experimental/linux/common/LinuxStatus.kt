 ...
 */
enum class LinuxStatus(val code: Int, val description: String) {
    ...
    companion object {
        val map: Map<Int, LinuxStatus> = LinuxStatus.values().associateBy { it.code }

        fun from(code: Int) = map.getValue(code)
        fun fromOrNull(code: Int) = map[code]
    }
}
