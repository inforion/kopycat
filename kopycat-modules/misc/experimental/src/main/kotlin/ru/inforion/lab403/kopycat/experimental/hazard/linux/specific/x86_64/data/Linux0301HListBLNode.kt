...
/**
 * [Sources on bootlin](https://elixir.bootlin.com/linux/v3.1/source/include/linux/list_bl.h#L37)
 */
class Linux0301HListBLNode(offsetable: IOffsetable) {
    ...
    inner class Raw {
        val next = OffsetField(_offsetable, "next", 0x00uL, Datatype.QWORD)
        val pPrev = OffsetField(_offsetable, "pprev", 0x08uL, Datatype.QWORD)
    }
}
