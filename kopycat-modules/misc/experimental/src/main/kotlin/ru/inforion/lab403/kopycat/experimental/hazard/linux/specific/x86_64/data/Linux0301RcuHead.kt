...
/**
 * [Sources on bootlin](https://elixir.bootlin.com/linux/v3.1/source/include/linux/rcupdate.h#L72)
 */
class Linux0301RcuHead(offsetable: IOffsetable) {
    ...
    inner class Raw {
        val next = OffsetField(_offsetable, "next", 0x0uL, Datatype.QWORD)
        val head = OffsetField(_offsetable, "func", 0x8uL, Datatype.QWORD)
    }
