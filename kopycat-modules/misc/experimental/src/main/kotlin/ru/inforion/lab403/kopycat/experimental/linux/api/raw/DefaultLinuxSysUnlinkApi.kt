...
import ru.inforion.lab403.kopycat.experimental.linux.api.interfaces.LinuxSysUnlinkCapturableApi


class DefaultLinuxSysUnlinkApi(
    val abi: IAbi,
    override val PTR_SYS_UNLINK: ULong
) : LinuxSysUnlinkCapturableApi {
    override fun sysUnlinkCapturable(filename: String): CapturableNoBody = abi.argsCapturable(
        filename.toArg(),
    )
}