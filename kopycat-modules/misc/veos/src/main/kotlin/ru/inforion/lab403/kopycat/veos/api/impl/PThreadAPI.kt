...
class PThreadAPI(os: VEOS<*>) : API(os) {
    ...
    val pthread_create = object : APIFunction("pthread_create") {
        ...
        override fun exec(name: String, vararg argv: ULong): APIResult {
            ...
            if (attr != 0uL) {
                ...
                priority = th_attr.__schedparam.sched_priority.int
            }
            ...
            os.abi.writeInt(thread, currentThread.id.ulong_z)
    ...
    val pthread_join = object : APIFunction("pthread_join") {
        ...
        override fun exec(name: String, vararg argv: ULong): APIResult {
            ...
            os.findProcessById(thread.int) ?: return retval(PosixError.ESRCH.id)
            ...
            os.block<PosixThread> {
                execute {
                    ...
                    while (true) {
                        ...
                        if (availableThread.id == thread.int)
                            break
                ...
                failure {
                    -1uL // TODO: Is failure possible here?
                }
            }
