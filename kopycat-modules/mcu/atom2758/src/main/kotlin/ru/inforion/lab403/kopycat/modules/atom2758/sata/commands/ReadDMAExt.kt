...
internal class ReadDMAExt : IIDECommand {
    override val setDSC = false
    override val name: String = "READ_DMA_EXT"

    override fun execute(port: Port, slot: Int) = port.run {
        ideCmdLba48Transform(true)
        ideSectorDMARW(true, slot, false)
        false
    }
}
