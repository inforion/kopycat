...
class MBD16(parent: Module, name: String) : Module(parent, name) {
    ...
    private val REG_48 = object : Register(ports.msg, 0x48u, WORD, "REG_48", level = CONFIG) {
        override fun read(ea: ULong, ss: Int, size: Int): ULong = 0x10000A0u
    }
}