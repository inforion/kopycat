...
import ru.inforion.lab403.kopycat.modules.atom2758.e1000.protocols.CarelessEthernet
import ru.inforion.lab403.kopycat.modules.atom2758.e1000.sources.NullSource
...
class E1000(
    ...
    companion object {
        ...
        const val BUS_MEM_INDEX = 17

        val REG_LOG_LEVEL: Level = Level.FINE

        /** Default MAC address */
        val DEFAULT_MAC = byteArrayOf(0x90.byte, 0x6c, 0xac.byte, 0x74, 0x86.byte, 0xf0.byte)
    ...
    val mem = ports.Slave("mem", BUS_MEM_SIZE)
    ...
    @Suppress("unused")
    private val BAR0 = PCI_BAR(0x10, DWORD, "BAR0", BUS_MEM_SIZE, BRIDGE.MEMORY_AREA, busMemIndex, Level.SEVERE)
    ...
    */
    ...
    private open inner class RClrRegister(port: SlavePort, address: ULong, datatype: Datatype, name: String) :
