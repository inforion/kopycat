...
class stm32f042_example(
    ...
    companion object {
        ...
        private fun createMCU(parent: Module, name: String, firmware: String) = when {
            ...
            else -> throw IllegalArgumentException("Wrong firmware prefix should be '$EXAMPLE', '$FILE', '$RESOURCE', '$BYTES'")
        }
    }
    ...
    fun sendStringIntoUART1(string: String) = term1.addStringToReceiveBuffer(string)
    fun sendStringIntoUART2(string: String) = term2.addStringToReceiveBuffer(string)
