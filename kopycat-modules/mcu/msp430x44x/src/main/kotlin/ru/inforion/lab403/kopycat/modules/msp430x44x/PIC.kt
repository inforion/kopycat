...
class PIC(parent: Module, name: String) : APIC(parent, name) {
    ...
    val IE2 = object : Register(ports.mem, 0x01u, BYTE, "IE2") {
        ...
        override fun write(ea: ULong, ss: Int, size: Int, value: ULong) {
            ...
            USART1RX_INT.enabled = URXIE1.truth
            USART1TX_INT.enabled = UTXIE1.truth
    ...
    val IFG1 = object : Register(ports.mem, 0x02u, BYTE, "IFG1") {
        override fun write(ea: ULong, ss: Int, size: Int, value: ULong) {
            super.write(ea, ss, size, value)
    ...
    val IFG2 = object : Register(ports.mem, 0x03u, BYTE, "IFG2") {
        override fun write(ea: ULong, ss: Int, size: Int, value: ULong) {
            super.write(ea, ss, size, value)
    ...
    val ME1 = object : Register(ports.mem, 0x04u, BYTE, "ME1") {
        override fun write(ea: ULong, ss: Int, size: Int, value: ULong) {
            super.write(ea, ss, size, value)
    ...
    val ME2 = object : Register(ports.mem, 0x05u, BYTE, "ME2") {
