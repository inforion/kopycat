...
class Cvtsd2ss(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>) :
    ASSEInstruction(core, opcode, prefs, *operands) {

    override val mnem = "cvtsd2ss"
    ...
    override fun executeSSEInstruction() {
        ...
        op1.extValue(core, a1.insert(a2.ieee754().float.ieee754AsUnsigned().ulong_z, 31..0))
    }
}
