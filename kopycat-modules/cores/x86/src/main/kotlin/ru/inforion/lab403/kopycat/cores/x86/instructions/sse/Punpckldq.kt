...
class Punpckldq(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>) :
    ASSEInstruction(core, opcode, prefs, *operands) {

    override val mnem = "punpckldq"
    ...
    override fun executeSSEInstruction() {
        ...
        val result = BigInteger.ZERO
            .insert(dest[31..0], 31..0)
            .insert(src[31..0], 63..32)
            .insert(dest[63..32], 95..64)
            .insert(src[63..32], 127..96)
