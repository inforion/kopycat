...
class Psrldq(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>) :
    ASSEInstruction(core, opcode, prefs, *operands) {

    override val mnem = "psrldq"
    ...
    override fun executeSSEInstruction() {
        ...
        op1.extValue(core, a1 ushr (temp.int * 8))
    }
}
