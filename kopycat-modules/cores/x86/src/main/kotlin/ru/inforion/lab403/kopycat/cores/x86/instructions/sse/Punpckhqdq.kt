...
class Punpckhqdq(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>) :
    ASSEInstruction(core, opcode, prefs, *operands) {

    override val mnem = "punpckhqdq"
    ...
    override fun executeSSEInstruction() {
        ...
        val result = BigInteger.ZERO
            .insert(dest[127..64], 63..0)
            .insert(src[127..64], 127..64)
