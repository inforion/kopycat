...
class Configuration : IAutoSerializable {
    ...
    private val msr = dictionary<ULong, ULong>()
    ...
    fun rdmsrOrThrow(id: ULong) = rdmsr(id) ?: error("MSR with id=0x${id.hex} not defined")
    ...
    inner class MSRDelegate(val msr: eMSR) {
        ...
        operator fun setValue(thisRef: Any?, property: KProperty<*>, value: ULong) = msr(msr.offset, value)
    }
