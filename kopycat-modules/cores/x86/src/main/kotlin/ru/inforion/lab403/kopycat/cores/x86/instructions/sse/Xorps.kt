...
class Xorps(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>) :
    ASSEInstruction(core, opcode, prefs, *operands) {

    override val mnem = if (!prefs.operandOverride) {
        "xorps"
    } else {
        "xorpd"
    }
