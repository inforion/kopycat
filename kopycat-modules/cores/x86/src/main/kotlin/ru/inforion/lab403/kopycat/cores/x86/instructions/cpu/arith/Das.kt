...
class Das(core: x86Core, opcode: ByteArray, prefs: Prefixes): AX86Instruction(core, Type.VOID, opcode, prefs) {
    override val mnem = "das"
    ...
    override fun execute() {
        ...
        if ((al > 0x9Fu) or core.cpu.flags.cf){
            al -= 0x60u
