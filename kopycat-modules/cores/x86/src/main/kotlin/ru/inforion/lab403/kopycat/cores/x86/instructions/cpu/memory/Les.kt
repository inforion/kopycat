...
import ru.inforion.lab403.kopycat.cores.x86.operands.x86Register.SSR.es.value
import ru.inforion.lab403.kopycat.modules.cores.x86Core


class Les(core: x86Core, opcode: ByteArray, prefs: Prefixes, op1: AOperand<x86Core>, op2: AOperand<x86Core>):
        AX86Instruction(core, Type.VOID, opcode, prefs, op1, op2) {
    override val mnem = "les"
