...
class Cmovle(core: x86Core, opcode: ByteArray, prefs: Prefixes, op1: AOperand<x86Core>, op2: AOperand<x86Core>):
    AX86Instruction(core, Type.COND_JUMP, opcode, prefs, op1, op2) {
    override val mnem = "Cmovle"

    override fun execute() {
        if(core.cpu.flags.zf || (core.cpu.flags.sf != core.cpu.flags.of))
