...
class PsradDC(core: x86Core) : ADecoder<AX86Instruction>(core) {
    override fun decode(s: x86OperandStream, prefs: Prefixes): AX86Instruction {
        ...
        val operands = when (opcode) {
            ...
            // TODO: NP 0F E2 /r1 PSRAD mm, mm/m64
            // TODO: 66 0F E2 /r PSRAD xmm1, xmm2/m128
            else -> throw GeneralException("Incorrect opcode in decoder $this")
        }

        return Psrad(core, s.data, prefs, *operands)
    }
}
