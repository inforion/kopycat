...
/**
 * Look at [ru.inforion.lab403.kopycat.cores.x86.instructions.sse.Sqrtsd] for reference
 *
 * https://www.felixcloutier.com/x86/fsqrt
 */
class Fsqrt(core: x86Core, opcode: ByteArray, prefs: Prefixes, operand: AOperand<x86Core>) :
