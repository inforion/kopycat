...
class Punpckhdq(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>) :
    ASSEInstruction(core, opcode, prefs, *operands) {

    override val mnem = "punpckhdq"
    ...
    override fun executeSSEInstruction() {
        ...
        val result = BigInteger.ZERO
            .insert(dest[95..64], 31..0)
            .insert(src[95..64], 63..32)
            .insert(dest[127..96], 95..64)
            .insert(src[127..96], 127..96)
