...
class Mulss(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>) :
    ASSEInstruction(core, opcode, prefs, *operands) {

    override val mnem = "mulss"
    ...
    override fun executeSSEInstruction() {
        ...
        val low32 = (a1[31..0].uint.ieee754() * a2.ieee754()).ieee754AsUnsigned()
        op1.extValue(core, a1.insert(low32.ulong_z, 31..0))
    }
}
