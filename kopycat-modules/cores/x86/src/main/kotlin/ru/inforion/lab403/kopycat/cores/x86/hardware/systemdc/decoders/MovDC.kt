...
class MovDC(core: x86Core) : ADecoder<AX86Instruction>(core) {
    ...
    override fun decode(s: x86OperandStream, prefs: Prefixes): AX86Instruction {
        ...
        val ops = when (opcode) {
            ...
            0xA3 -> arrayOf(s.mem(prefs), xax(prefs.opsize))

            0xB0, 0xB1, 0xB2, 0xB3, 0xB4, 0xB5, 0xB6, 0xB7 ->
                arrayOf(gprr8(opcode % 0xB0, prefs.rexB, prefs.rex), s.imm8)

            0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0xBE, 0xBF ->
                arrayOf(gprr(opcode % 0xB8, prefs.rexB, prefs.opsize), s.immMov(prefs))
