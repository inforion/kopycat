...
class Sqrtsd(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>) :
    ASSEInstruction(core, opcode, prefs, *operands) {

    override val mnem = "sqrtsd"
    ...
    override fun executeSSEInstruction() {
        ...
        val low64 = sqrt(a2.ieee754()).ieee754AsUnsigned()
        // println("dfgdfgfd: $a2, $low64, ${a2[63..0]}")
