...
import ru.inforion.lab403.kopycat.cores.x86.instructions.cpu.stack.Leave
import ru.inforion.lab403.kopycat.modules.cores.x86Core


class LeaveDC(core: x86Core) : ADecoder<AX86Instruction>(core) {
    override fun decode(s: x86OperandStream, prefs: Prefixes): AX86Instruction {
        ...
        return Leave(core, s.data, prefs)
    }
}