...
import ru.inforion.lab403.kopycat.cores.x86.instructions.sse.Cvttsx2si
import ru.inforion.lab403.kopycat.modules.cores.x86Core

class Cvttsx2siDC(core: x86Core) : ADecoder<AX86Instruction>(core) {
    override fun decode(s: x86OperandStream, prefs: Prefixes): AX86Instruction {
        ...
        val operands = when (opcode) {
            0x2C -> arrayOf(
                rm.rpref,
                when (rm.prefixes.string) {
                    StringPrefix.REPNZ -> rm.xmmm64 // cvttsd2si
                    StringPrefix.REPZ -> rm.xmmm32 // cvttss2si
        ...
        return Cvttsx2si(core, s.data, prefs, *operands)
    }
}
