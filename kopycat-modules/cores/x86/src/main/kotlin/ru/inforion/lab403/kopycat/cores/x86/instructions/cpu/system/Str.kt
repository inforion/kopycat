 ...
 *
 * */
class Str(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>):
    AX86Instruction(core, Type.VOID, opcode, prefs, *operands) {
    override val mnem = "str"

    override fun execute() {
        // костыли
        // core.cop.tssr = core.mmu.readTaskStateSegment(core.cop.tssr).base[0..15]
        // core.cop.tssr = 0x0030uL

        op1.value(core, core.cop.tssr)
    }
}