...
abstract class v850ESHardwareException(excCode: Enum<*>, where: ULong, message: String? = null):
        HardwareException(excCode, where, message) {
    // TODO: Change pc value
    object IncorrectSegment: v850ESHardwareException(ExcCode.IncorrectSegment, -1uL)
    object DivisionByZero: v850ESHardwareException(ExcCode.DivisionByZero, -1uL)
    object Overflow: v850ESHardwareException(ExcCode.Overflow, -1uL)
}