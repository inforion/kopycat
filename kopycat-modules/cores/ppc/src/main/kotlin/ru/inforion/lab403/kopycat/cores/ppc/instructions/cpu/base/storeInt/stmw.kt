...
*/
class stmw(core: PPCCore, val condRegField: ULong, val length: Boolean, val data: ULong, vararg operands: AOperand<PPCCore>):
    ...
    override fun execute() {
        ...
        var ea = b + data.signextRenameMeAfter(15)
