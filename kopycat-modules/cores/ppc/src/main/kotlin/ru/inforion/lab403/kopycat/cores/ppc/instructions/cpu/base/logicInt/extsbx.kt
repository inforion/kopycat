...
//Extend sign byte
class extsbx(core: PPCCore, val fieldA: Int, val fieldB: Int, val fieldC: Int, val flag: Boolean):
        APPCInstruction(core, Type.VOID) {
    override val mnem = "extsb${if (flag) "." else ""}"
    ...
    override fun execute() {
        result.value(core, rs.value(core).signextRenameMeAfter(7))
