...
//NAND
class nandx(core: PPCCore, val fieldA: Int, val fieldB: Int, val fieldC: Int, val flag: Boolean):
        APPCInstruction(core, Type.VOID) {
    override val mnem = "nand${if (flag) "." else ""}"
    ...
    override fun execute() {
        result.value(core, (rs.value(core) and rb.value(core)).inv())
