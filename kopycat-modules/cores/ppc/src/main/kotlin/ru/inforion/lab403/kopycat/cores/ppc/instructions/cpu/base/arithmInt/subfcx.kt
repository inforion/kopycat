...
class subfcx(core: PPCCore, val overflow: Boolean, val record: Boolean, vararg operands: AOperand<PPCCore>):
        APPCInstruction(core, Type.VOID, *operands) {
    override val mnem = "subfc${if (overflow) "o" else ""}${if (record) "." else ""}"
