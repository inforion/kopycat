...
class dadd(
    ...
    override fun execute() {
        ...
        val t_vrt = vrt.bigint.insert(vrt[63], 64)

        val temp = t_vrs + t_vrt

        if (temp[64] != temp[63]) throw MipsHardwareException.OV(core.pc) else vrd = temp[63..0].ulong
