...
class RsRtPosSize(
        core: MipsCore,
        val construct: (MipsCore, Long, MipsRegister, MipsRegister, MipsImmediate, MipsImmediate) -> AMipsInstruction
) : ADecoder(core) {
    ...
    override fun decode(data: Long): AMipsInstruction {
        ...
        val msb = data[15..11]
        val lsb = data[10..6]
        return construct(core, data, gpr(rt), gpr(rs), imm(lsb), imm(msb))
    }
}