...
// TODO: merge with smth?
class SDBBP(core: MipsCore,
            val constructLow: (MipsCore, ULong, Int) -> AMipsInstruction) : ADecoder(core) {

    override fun decode(data: ULong): AMipsInstruction {
        require (!isExtended(data)) { "Not implemented" }

        val code = data[10..5].int

        return constructLow(core, data, code)
    }
}