...
class TLBEntry64 (
    ...
    constructor() : this(0, 0u, 0u, 0u, 0u, 39)

    override val VPN2 = entryHi[VPN2border..13]
    val VPN2X = entryHi[12..11]
    ...
    companion object {
        ...
        fun createTlbEntry(
            ...
            // с. 48 PRA MIPS64
            val VPN2_RANGE = segbits + 12 .. 13
            val pageMask = insert(mask, MASK_RANGE)
            val entryHi = insert(vAddress[segbits - 1..13] and inv(mask), VPN2_RANGE)
            ...
            return TLBEntry64(entryId, pageMask, entryHi, entryLo0, entryLo1, segbits + 12)
        }
    }
}