...
class SLL_EXT(core: MipsCore,
              val construct: (MipsCore, ULong, MipsRegister, MipsRegister, MipsImmediate, MipsImmediate, Boolean) -> AMipsInstruction) : ADecoder(core) {
    ...
    override fun decode(data: ULong): AMipsInstruction {
        ...
        return construct(core, data, gpr16(rx), gpr16(ry), imm(lsb), imm(msb), flag)
    }
}