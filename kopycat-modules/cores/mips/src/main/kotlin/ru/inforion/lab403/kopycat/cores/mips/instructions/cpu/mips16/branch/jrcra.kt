...
class jrcra(
        core: MipsCore,
        data: ULong,
        unused: MipsRegister) : AMipsInstruction16(core, data, Type.JUMP)  {

    override val mnem = "jrc"

    override fun execute() {
        val address = core.reg(31)
        core.cpu.branchCntrl.schedule(address clr 0, 0, InstructionSet.from(address))
    }
}