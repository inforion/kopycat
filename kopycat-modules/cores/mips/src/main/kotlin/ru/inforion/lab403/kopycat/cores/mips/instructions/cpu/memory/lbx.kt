 ...
 *
 * ```
 * SPECIAL3 base   index  rd     LBX    LX
 * 0111111  xxxxx  xxxxx  xxxxx  10110  001010
 * ```
 */
class lbx(core: MipsCore,
          data: ULong,
    ...
    override fun execute() {
        ...
        val memword = core.read(Datatype.BYTE, vAddr).signext(7)
