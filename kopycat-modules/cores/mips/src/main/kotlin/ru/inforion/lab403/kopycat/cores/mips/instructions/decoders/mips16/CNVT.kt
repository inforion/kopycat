...
// TODO: merge with JALRC?
class CNVT(core: MipsCore,
           val constructLow: (MipsCore, ULong, MipsRegister) -> AMipsInstruction) : ADecoder(core) {
    ...
    override fun decode(data: ULong): AMipsInstruction {
        ...
        return constructLow(core, data, gpr16(rx))
    }
}