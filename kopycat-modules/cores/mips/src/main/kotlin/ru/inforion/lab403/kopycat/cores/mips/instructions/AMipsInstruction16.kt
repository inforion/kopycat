...
abstract class AMipsInstruction16(core: MipsCore, data: ULong, type: Type, vararg operands: AMipsOperand) :
        AMipsInstruction(core, data, type, *operands), ITableEntry {

    final override val size = 2
}
