...
class b(
        core: MipsCore,
        data: ULong,
        val off: MipsImmediate) : AMipsInstruction16(core, data, Type.JUMP, off)  {

    override val mnem = "b"

    override fun execute() {
        val offset = (off.value shl 1).signextRenameMeAfter(8)
        core.cpu.branchCntrl.schedule(core.pc + 2u + offset, 0)
    }
}