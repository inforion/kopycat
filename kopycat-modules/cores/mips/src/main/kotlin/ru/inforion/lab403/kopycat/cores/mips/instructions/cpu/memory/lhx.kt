...
/**
 * From DSP for Mips64, Rev3.02, page 146
 *
 * ```
 * SPECIAL3 base   index  rd     LHX    LX
 * 0111111  xxxxx  xxxxx  xxxxx  00100  001010
 * ```
 */
class lhx(
    core: MipsCore,
    ...
    override fun execute() {
        ...
        val memword = core.read(Datatype.WORD, vAddr).signext(15)
