...
class TLBEntry32(index: Int, pageMask: ULong, entryHi: ULong, entryLo0: UInt, entryLo1: UInt
) : ATLBEntry(index, pageMask, entryHi, entryLo0, entryLo1) {

    constructor() : this(0, 0u, 0u, 0u, 0u)

        override val VPN2 = entryHi[31..13]
        ...
        companion object {
            ...
            fun createTlbEntry(entryId: Int, vAddress: ULong, pAddress: ULong, size: Int, pabits: Int): TLBEntry32 {
                ...
                val entryLo1 = insert(pfn1, PFN_RANGE)
                    ...
                    .insert(1u, V_RANGE)
                    .insert(1u, G_RANGE)
                return TLBEntry32(entryId, pageMask.ulong_z, entryHi.ulong_z, entryLo0, entryLo1)
            }
        }
    }
