...
class Empty(core: MipsCore, val construct: (MipsCore, ULong) -> AMipsInstruction) : ADecoder(core) {
    override fun decode(data: ULong): AMipsInstruction = construct(core, data)
}