...
) : AMipsInstruction(core, data, Type.VOID, base) {
    override val mnem = "zcbt"

    override fun execute() {
        // This instruction is used in Linux in a function that is built by build_clear_page (arch/mips/mm/page.c)
