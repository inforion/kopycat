 ...
 *
 */
package ru.inforion.lab403.kopycat.cores.mips.instructions.cpu.mips16.move
...
class seh(
        core: MipsCore,
        data: ULong,
        val rx: MipsRegister) : AMipsInstruction16(core, data, Type.VOID, rx)  {

    override val mnem = "seh"

    override fun execute() {
        rx.value(core, rx.value(core)[15..0].signextRenameMeAfter(15))
    }
}