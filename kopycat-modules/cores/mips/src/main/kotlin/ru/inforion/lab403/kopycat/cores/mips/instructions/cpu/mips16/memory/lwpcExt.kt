 ...
 * LW rx, offset(pc)
 */
class lwpcExt(core: MipsCore,
              data: ULong,
              val rx: MipsRegister,
              val off: MipsImmediate) : AMipsInstruction(core, data, Type.VOID, rx, off) {

    override val mnem = "lw"

    override fun execute() {
        val address = (core.pc clr 1..0) + off.value.signextRenameMeAfter(15)
        if (address[1..0] != 0uL)
