...
class ADCi(cpu: AARMCore,
    ...
    override val mnem = "ADC${if(setFlags) "S" else ""}$mcnd"

    override fun execute() {
        val (result, carry, overflow) = AddWithCarry(rn.dtyp.bits, rn.value(core), imm32.value, core.cpu.flags.c.asInt)
