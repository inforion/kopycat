...
class ANDr(cpu: AARMCore,
    ...
    override val mnem = "AND${if(setFlags) "S" else ""}${if(core.cpu.CurrentInstrSet() == AARMCore.InstructionSet.ARM) mcnd else ""}"
    ...
    override fun execute() {
        ...
        result.and(core, rn, Immediate(shifted))
