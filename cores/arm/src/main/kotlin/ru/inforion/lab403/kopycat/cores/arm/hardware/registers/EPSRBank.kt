...
class EPSRBank(cpu: AARMCore) : ARegistersBank<AARMCore, Flags>(cpu, Flags.values(), bits = 32) {
    override val name: String = "ARM Execution Program Status Register Bank"
    var t by bitOf(ARMRegister.PSR.EPSR, 24)
}