...
import ru.inforion.lab403.kopycat.cores.arm.instructions.cpu.special.MSR
...
//    private val msrr = MSRRegSLDecoder(cpu, ::MSRsl)
...
//                    "000, 1, 01, xx01" to msrr,
//                    "000, 1, 01, xx1x" to msrr,
//                    "000, 1, 11,  -  " to msrr,
                    "001, -, 01,  -  " to bx,
                    "011, -, 01,  -  " to blxr))
    ...
    private val msri = MSRImmDecoder(cpu, ::MSR)
