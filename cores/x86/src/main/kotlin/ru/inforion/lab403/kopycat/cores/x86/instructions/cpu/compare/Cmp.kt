package ru.inforion.lab403.kopycat.cores.x86.instructions.cpu.compare
...
/**
 * Created by v.davydov on 21.09.16.
 */

class Cmp(core: x86Core, opcode: ByteArray, prefs: Prefixes, vararg operands: AOperand<x86Core>):
    ...
    override fun execute() {
        ...
        val a2 = if(op2 is Immediate) op2.ssext(core) mask op1.dtyp.bits else op2.value(core)
        val res = a1 - a2
