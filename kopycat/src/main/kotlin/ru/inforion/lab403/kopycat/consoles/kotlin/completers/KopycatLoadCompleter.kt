...
internal class KopycatLoadCompleter : ICustomArgumentCompleter {
    override fun complete(
        line: ParsedLine?,
        kopycat: Kopycat,
    ) = (
        Common.completeRelativeFileList("snapshot", kopycat.snapshotsDir.toFile()) {
            it.extension == settings.snapshotFileExtension
        } ?: emptySequence()
    ).asIterable()
}
