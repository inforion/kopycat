 ...
 *
 * Внимание: будьте осторожны при использовании наследования классов!
 ...
 * Иначе, иерархия компонентов будет построенна некорректно ввиду присутствия в ней ненужной копии от
 * класса-родителя.
 *
